    ...
    <div className="animate-in">
      ...
      <div className="page-content space-y-7">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          {metricas !== null && (
            <div className="card p-6">
              <div className="mb-5 flex items-center gap-2.5">
                ...
                <h2 className="text-sm font-semibold tracking-normal text-foreground">Funil de Projetos</h2>
              </div>
                  ...
                  return (
                    <div key={key}>
                      <div className="mb-1.5 flex items-center justify-between text-sm">
                        ...
                        <span className="text-sm font-semibold tracking-normal text-foreground">{String(value)}</span>
                      </div>
                      <div className="h-2 w-full overflow-hidden rounded-[9999px] bg-muted">
                        <div
                          className={`h-2 rounded-[9999px] transition-all duration-700 ${color}`}
          ...
          <div className="card p-6">
            <h2 className="mb-5 text-sm font-semibold tracking-normal text-foreground">Acesso Rápido</h2>
            <div className="space-y-3">
              {[
                ...
                <Link
                  key={to}
                  to={to}
                  className="flex items-center gap-3.5 rounded-[8px] border border-border px-4 py-3.5 transition-all hover:border-navy/20 hover:bg-muted/70"
                >
                  <div className={`flex h-10 w-10 items-center justify-center rounded-[8px] ${color}`}>
