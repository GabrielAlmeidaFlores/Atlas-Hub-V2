...
const mockProjetos: Projeto[] = [
  ...
  },
  {
    ...
    fotosUrls: ["/lp/projeto-jardins.jpg"],
  ...
  },
  {
    ...
    estado: "SC",
    endereco: "Jurerê Internacional",
    descricao: "Club deal residencial em Jurerê com oferta privada publicada.",
    valorTotal: 18_000_000,
    valorCaptar: 7_500_000,
    prazoObra: 24,
    prazoRetorno: 36,
    rentabilidadeEstimada: 22.0,
    modeloRetorno: "SCP",
    tipoOferta: "PRIVADA",
    ofertaId: "offer-final-demo",
    ofertaLink: "https://investir.atlashub.example/oferta/atlantic-jurere",
    ofertaConfirmadaEm: "2026-06-12T10:00:00.000Z",
    fotosUrls: ["/lp/projeto-jurere.jpg"],
    criadoEm: "2026-05-01T10:00:00.000Z",
    atualizadoEm: "2026-06-12T10:00:00.000Z",
  },
  {
    id: "proj-5",
    incorporadoraId: "user-inc-1",
    status: "OFERTA_CRIADA",
    revisao: 1,
    nome: "Horizon Parque Sul",
    modelo: "VENDA",
    tipoImovel: "RESIDENCIAL",
    cidade: "Curitiba",
    estado: "PR",
    endereco: "Bairro Batel",
    descricao: "Residencial com áreas verdes e oferta pública ativa.",
    valorTotal: 9_200_000,
    valorCaptar: 3_800_000,
    prazoObra: 18,
    prazoRetorno: 30,
    ...
    ofertaConfirmadaEm: "2026-07-01T10:00:00.000Z",
    fotosUrls: ["/lp/projeto-porto.jpg"],
  ...
  },
  {
    ...
    status: "OFERTA_CRIADA",
    revisao: 1,
    nome: "Vista Mar Recife",
    modelo: "VENDA",
    tipoImovel: "RESIDENCIAL",
    cidade: "Recife",
    estado: "PE",
    endereco: "Boa Viagem",
    descricao: "Residencial frente-mar com oferta pública ativa.",
    ...
    modeloRetorno: "SCP",
    tipoOferta: "PUBLICA",
    ofertaId: "offer-vista-mar",
    ofertaLink: "https://investir.atlashub.example/oferta/vista-mar-recife",
    ofertaConfirmadaEm: "2026-07-08T10:00:00.000Z",
    criadoEm: "2026-06-01T10:00:00.000Z",
    atualizadoEm: "2026-07-08T10:00:00.000Z",
    fotosUrls: ["/lp/projeto-recife.jpg"],
  },
  {
    id: "proj-7",
    incorporadoraId: "user-inc-1",
    status: "OFERTA_CRIADA",
    revisao: 1,
    nome: "Office Center BH",
    modelo: "VENDA",
    tipoImovel: "COMERCIAL",
    cidade: "Belo Horizonte",
    estado: "MG",
    endereco: "Savassi",
    descricao: "Torre comercial com salas prontas e oferta publicada.",
    ...
    ofertaConfirmadaEm: "2026-07-15T10:00:00.000Z",
    criadoEm: "2026-06-10T10:00:00.000Z",
    atualizadoEm: "2026-07-15T10:00:00.000Z",
    fotosUrls: ["/lp/projeto-bh.jpg"],
  },
];
...
export const handlers = [
  ...
  http.get(`${BASE}/admin/financeiro/cartoes/:projetoId`, () => HttpResponse.json({
    ...
    podeRegistrar: false,
    bloqueios: [
      { codigo: "SEM_CRONOGRAMA", mensagem: "Cadastre etapas no cronograma para calcular o limite." },
