...
export const USE_LOCAL_BACKEND = import.meta.env["VITE_USE_LOCAL_BACKEND"] === "true";
export const USE_LOCAL_MOCKS = import.meta.env.DEV && VITE_MODE === "development" && !USE_LOCAL_BACKEND;

export const VITE_API_URL = USE_LOCAL_MOCKS
  ? ""
  : USE_LOCAL_BACKEND
    ? "http://localhost:3000/dev"
    : (import.meta.env["VITE_API_URL"] as string ?? "http://localhost:3000/dev");
